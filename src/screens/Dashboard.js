  ...
  return (
    <View>
        ...
        <View style={{flexDirection:'row',justifyContent:'space-around'}}>
            ...
            <TouchableOpacity onPress={()=>{navigation.navigate('Donors')}}  style={{flexDirection:'row',width:'80%', height: 150, backgroundColor: '#E0E0E0',  position: 'relative', margin: 10,  borderRadius: 8 }}>
                <View style={{padding:20,width:'70%'}}>
                    <Text>Registered Donors</Text>
                    <Text style={{marginTop:25,fontSize:50,fontWeight: "bold"}}>7</Text>
                </View>
                <View style={{padding:20,width:'30%',paddingTop:65}}>
